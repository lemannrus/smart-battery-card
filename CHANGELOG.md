...
- Add per-battery `ac_out_power_invert` support for signed power sensors
- Document EcoFlow Stream Pro battery-export configuration using `Power AC`

### Fixed

- Display negative Stream Pro export readings as positive output when sign inversion is enabled
- Keep power flowing in the opposite direction hidden instead of presenting it as battery output
